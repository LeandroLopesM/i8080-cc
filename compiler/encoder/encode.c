...
byte encode(comp_unit in)
{
    ...
    {
        case MOV:
        EXPECTS(in, "RDest, RSrc", in.opA && in.opB);
            out = m_MOV;
            out |= encode_register(*in.opA) >> 2;
            out |= encode_register(*in.opB) >> 5;
            break;
        case MVI:
        EXPECTS(in, "Register, byte", in.opA && in.opB);
            out = m_MVI;
            out |= encode_register(*in.opA) >> 2;
            *in.opA = *in.opB;
            break;
        ...
        EXPECTS(in, "Register, MemLo, MemHi", in.opA && in.opB && in.opC);
            out = m_LXI;
            out |= encode_regipair(*in.opA) >> 2;
            *in.opA = *in.opB;
            *in.opB = *in.opC;
            break;
        case LDA:
        EXPECTS(in, "MemLo, MemHi", in.opA, in.opB);
            out = m_LDA;
            break;
        case STA:
        EXPECTS(in, "MemLo, MemHi", in.opA && in.opB);
        ...
        EXPECTS(in, "Nothing", !in.opA && !in.opB && !in.opC);
            ...
            break;
        case ADD:
        EXPECTS(in, "Register", in.opA);
            out = m_ADD;
            out |= encode_register(*in.opA) >> 5;
            break;
        case ADI:
        EXPECTS(in, "Byte", in.opA);
            out = m_ADI;
            break;
        case ADC:
        EXPECTS(in, "Register", in.opA);
        ...
        EXPECTS(in, "Register", in.opA);
            ...
            break;
        case DAD:
        EXPECTS(in, "RegisterPair", in.opA);
            out = m_DAD;
            out |= encode_regpair(in.opA) >> 2;
            break;
        case DAA:
